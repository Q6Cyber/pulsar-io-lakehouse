...
public class SchemaConverter {
  ...
  public static StructField convertOneAvroFieldToDeltaField(
    ...
    switch (avroSchema.getType()) {
      ...
      case MAP:
        ...
        StructField deltaValueField = convertOneAvroFieldToDeltaField(valueSchema.getName(),
            valueSchema);
        ...
        ArrayType arrayType = new ArrayType(
            new StructType(structFields.toArray(new StructField[0])), false);
      ...
      case ARRAY:
        ...
        StructField deltaItemField = convertOneAvroFieldToDeltaField(itemSchema.getName(),
            itemSchema);
  ...
  public static StructType convertAvroSchemaToDeltaSchema(Schema pulsarAvroSchema) {
    ...
    StructField field = convertOneAvroFieldToDeltaField(pulsarAvroSchema.getName(),
        pulsarAvroSchema);
